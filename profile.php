...
<div class="content clearfix">
  ...
  <div class="main-content">
    ...
    <div class="post clearfix">
      <img src="images/dog7.jpg" alt="" class="post-image">
      <div class="post-preview">

        <div class="a"><li class="card_item" >Nom </li>:</div>
        <div class="a"><li class="card_item" >Espèce </li>:</div>
        <div class="a"><li class="card_item" >Genre </li>:</div>
        <div class="a"><li class="card_item" >Race</li>:</div>
        <div class="a"><li class="card_item" >Ville </li>:</div>
        <div class="a"><li class="card_item" >Description </li>:</div>
        <div class="btnAct">
